...
namespace AssetRetriever {
    ...
    public class AssetRetrieverEditorWindow : EditorWindow {
        ...
        public void CreateGUI() {
            ...
            // Import UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.renge.asset-retriever/Runtime/AssetRetrieverEditorWindow/AssetRetrieverEditorWindow.uxml");
            visualTree.CloneTree(root);

            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Packages/com.renge.asset-retriever/Runtime/AssetRetrieverEditorWindow/AssetRetrieverEditorWindow.uss");
